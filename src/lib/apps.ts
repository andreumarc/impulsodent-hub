...
export const APPS: AppDef[] = [
  ...
  },
  {
    ...
    description: 'Inteligencia de precios dentales: comparativa de mercado por zona, márgenes, recomendación estratégica (agresivo/medio/premium/mínimo rentable), simulador e informe ejecutivo PDF.',
    icon: 'LineChart',
    color: '#003A70',
    bgColor: '#e6eef7',
    url: process.env.NEXT_PUBLIC_URL_DENTAL_PRICE || 'https://dental-price-intelligence.vercel.app',
    status: 'active',
    category: 'Estratégico',
    badge: 'Nuevo',
  },
  {
    id: 'leadops',
    name: 'LeadOps CRM',
    description: 'CRM operativo de leads: captación multicanal (Meta, Google, WhatsApp), pipeline Kanban, ROI por campaña, SLA y ranking de agentes en tiempo real.',
    icon: 'Workflow',
    color: '#0d9488',
    bgColor: '#ccfbf1',
    url: process.env.NEXT_PUBLIC_URL_LEADOPS || 'https://dentalleads.impulsodent.com',
    status: 'active',
    category: 'CRM',
    badge: 'Nuevo',
  },
  {
    ...
    description: 'Calendario laboral anual para clínicas dentales: planificación de turnos, vacaciones, ausencias, festivos, reglas de cobertura mínima y motor de conflictos.',
    icon: 'CalendarCheck',
    color: '#003A70',
    bgColor: '#e6eef7',
    url: process.env.NEXT_PUBLIC_URL_WORKFORCE || 'https://workforce.impulsodent.com',
    status: 'active',
    category: 'RRHH',
    badge: 'Nuevo',
  },
